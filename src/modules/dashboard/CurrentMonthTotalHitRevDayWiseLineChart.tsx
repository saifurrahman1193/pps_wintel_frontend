...
import { currentMonthName } from '../../components/Helpers/CommonHelpers';

am4core.useTheme(am4themes_animated);

const CurrentMonthTotalHitRevDayWiseLineChart = ({ data }:any) => {
    useLayoutEffect(() => {
        // Create chart instance
        let chart = am4core.create("CurrentMonthTotalHitRevDayWiseLineChart", am4charts.XYChart);
        ...
        title.text = "Current Month: "+currentMonthName+" Total Hit & Revenue";
        title.fontSize = 25;
    ...
    return <div id="CurrentMonthTotalHitRevDayWiseLineChart" style={{ width: "100%", height: "450px" }}></div>;
};

export default CurrentMonthTotalHitRevDayWiseLineChart;
