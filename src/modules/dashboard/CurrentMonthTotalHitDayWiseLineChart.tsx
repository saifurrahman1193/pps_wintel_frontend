...
const CurrentMonthTotalHitDayWiseLineChart = ({ data }:any) => {
    useLayoutEffect(() => {
        // Create chart instance
        let chart = am4core.create("CurrentMonthTotalHitDayWiseLineChart", am4charts.XYChart);
        ...
        title.text = "Current Month: " + currentMonthName + " Total Hit";
        title.fontSize = 25;
    ...
    return <div id="CurrentMonthTotalHitDayWiseLineChart" style={{ width: "100%", height: "450px" }}></div>;
};

export default CurrentMonthTotalHitDayWiseLineChart;
